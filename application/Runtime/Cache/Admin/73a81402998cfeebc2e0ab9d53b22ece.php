...
<body>
<div class="formHeader"> <span class="title">发布文章</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
	<form name="frm" method="post" action="/admin.php/News/addnew.html" enctype="multipart/form-data" onsubmit="return checkAdd()">
